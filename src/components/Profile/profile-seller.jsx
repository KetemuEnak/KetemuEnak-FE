...
function ProfileSeller() {
  ...
  const profile = data.users.seller.find((event) => event.id === Number(profileId));
      ...
      <div className="w-full max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="md:flex gap-6">
          <aside className="bg-[#faf3eb] xl:min-w-[350px] md:max-w-[400px] rounded-xl p-8 shadow-lg self-start">
            ...
            <h1 className="text-2xl font-semibold text-gray-900 mt-2">{profile.store_name}</h1>
            <div className="text-left mt-8">
              ...
              <div className="mb-6">
                ...
                <Link className="text-base text-black font-medium font-serif text-[18px]" to={profile.social_media}>
          ...
          <div className="bg-[#faf3eb] max-w-[800px] md:max-w-full rounded-xl p-8 shadow-lg text-left self-start">
            <div className="flex justify-center">
              <img className="w-full max-w-[300px] md:max-h-[600px] rounded-sm" src={profile.banner} alt="Profile" />
            </div>
            <div className="mt-6">
