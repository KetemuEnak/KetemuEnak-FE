...
function HomeContent() {
  ...
  const filteredEvents = events.filter((event) => (isCity ? event.city === isCity : "" || event.title.toLowerCase().includes(searchTerm.toLowerCase())));
                        ...
                        <div className="md:flex items-center space-x-4">
                          ...
                          <div className="min-w-0 text-left">
                            <div className="flex flex-col md:flex-row justify-between xl:mr-14 xl:w-[800px]">
                              <h2 className="text-2xl ml-[-2px] md:text-3xl font-bold text-gray-900 dark:text-white">{event.title}</h2>
