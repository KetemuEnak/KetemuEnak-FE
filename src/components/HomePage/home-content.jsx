...
function HomeContent() {
  ...
  return (
    <div className="my-14">
      <div className="flex flex-col items-center mx-4 md:mx-14 lg:mx-auto lg:py-0 mb-10">
        <img className="max-h-[170px] md:max-h-[250px] xl:max-h-[350px] w-full md:w-screen xl:w-[1100px] rounded-3xl" src={Banner} alt="logo" />
      </div>
      <div className="mx-4 md:mx-auto max-w-screen-xl lg:py-3">
                      ...
                      <div className="md:flex items-center space-x-4">
                        ...
                        <div className="min-w-0 text-left">
                          <div className="flex flex-col md:flex-row justify-between xl:mr-14 xl:w-[800px]">
                            ...
                            <span className="text-white bg-indigo-600 focus:ring-4 focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2 mr-2 mb-2 focus:outline-none self-start">{event.city}</span>
                          </div>
